        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Toggle
              ...
              className={cn(editor.isActive("heading") && "bg-muted text-muted-foreground")}
            >
              <Heading1Icon />
            </Toggle>
          </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Toggle
                ...
                className={cn(editor.isActive("left") && "bg-muted text-muted-foreground")}
              >
                <AlignLeft />
              </Toggle>
            </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Toggle
                ...
                className={cn(editor.isActive("center") && "bg-muted text-muted-foreground")}
              >
                <AlignCenter />
              </Toggle>
            </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Toggle
                ...
                className={cn(editor.isActive("right") && "bg-muted text-muted-foreground")}
              >
                <AlignRight />
              </Toggle>
            </TooltipTrigger>
