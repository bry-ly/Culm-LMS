...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `https://${env.NEXT_PUBLIC_S3_BUCKET_NAME_IMAGES}.t3.storage.dev/${course.filekey}`,
          width: 1200,
          height: 630,
          alt: course.title,
        },
...
export default async function SlugPage({ params }: { params: Params }) {
  ...
  const jsonLd = {
    ...
    image: `https://${env.NEXT_PUBLIC_S3_BUCKET_NAME_IMAGES}.t3.storage.dev/${course.filekey}`,
